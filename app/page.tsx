  ...
  return (
    ...
    <div className="h-screen flex overflow-hidden">
      ...
      <div className="flex-1 bg-gray-100 flex justify-center items-start p-6 overflow-hidden">
        ...
        {/* SCROLLABLE CANVAS */}
        <div className="w-full max-w-[1200px] h-[95vh] bg-white rounded-2xl shadow-lg overflow-y-scroll">

          <div className="p-10 space-y-24">

            {site?.pages?.map((page: any) => (

              <div key={page.slug} className="space-y-24">
